...
inline common_http_url common_http_parse_url(const std::string & url) {
...
inline std::pair<httplib::Client, common_http_url> common_http_client(const std::string & url) {
...
inline std::string common_http_show_masked_url(const common_http_url & parts) {
