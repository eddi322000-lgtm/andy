...
private:
    ...
    // Parse a single SKILL.md file (no directory name validation)
    // Used for skills/tmp/SKILL.md pattern
    std::optional<skill_metadata> parse_skill_single(const std::string & skill_file_path);
